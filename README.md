...
本轮演示新增“美的采集者”与接力社群：主页进入“小在带回的此刻”，可查看北京/深圳的明确演示种子、收藏一张“我赶上的这一场”、保存匿名或署名的本机贡献草稿，并体验双向同意后才揭面的匹配。相关前端状态集中在 current-moments.js，样式在 current-moments.css；种子数据不会冒充实时信息，草稿不会冒充已发布内容。
